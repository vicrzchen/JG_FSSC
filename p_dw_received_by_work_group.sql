...
-- 插入统计数据
INSERT INTO dw_received_tickets (work_group, received_count, stat_date, period_type, company_type)
-- 当天数据统计
SELECT 
    work_group,
...
-- CREATE INDEX idx_fssc_inst_query ON t_share_fssc_inst(del_flag_, work_group, create_time_);
